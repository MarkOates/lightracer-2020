...
private:
   ...
   Racer *racer;
   int current_racer_health;
   int current_racer_max_health;
   int current_lap_num;
   int num_laps_to_win;
   FontBin &fonts;
   int screen_width;
...
public:
   Hud(int num_of_segments_in_track, Racer *racer, int current_racer_health, int current_racer_max_health, int current_lap_num, int num_laps_to_win, FontBin &fonts, int screen_width, Timer &stopwatch, int num_lives);
   ~Hud();
